...
jQuery(function($) {
    ...
    $("#quickcontact_submit").on( "click", function(event) {
        ...
        $.ajax({
            type: "POST",
            dataType: "json",
            url: "http://www.wistronits.com/cn/js/php/quick-contact.php",
            data: mydata,
    ...
    $("#Submitbtn").on( "click", function(event) {
        ...
        $.ajax({
            type: "POST",
            dataType: "json",
            url: "http://www.wistronits.com/cn/js/php/contact.php",
            data: mydata,
            success: function(data) {
    ...
    $("#subscribe_button").on( "click", function(event) {
        ...
        $.ajax({
            type: "POST",
            dataType: "json",
            url: "http://www.wistronits.com/cn/js/php/newsletter.php",
            data: mydata,
            success: function(data) {
